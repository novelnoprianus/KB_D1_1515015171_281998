...
%output dari program ini adalah ui yansen dan sri sugiarto
...
%Selanjutnya date mengambil bulan pada sistem komputer, yaitu bulan April
%Sehingga April diikatkan pada variabel Bulan_ini sehingga proses berhasil lalu lanjut subgoal berikutnya
%Subgoal berikutnya yaitu daftar_telepon(Orang, _, Tanggal) didalam sub goal ini terdiri dari 1 data, selanjutnya melakukan pengecekan unifikasi ada data yang ada
%Data pertama pada daftar_telepon adalah daftar_telepon(orang(ui, yansen), _, tanggal_lahir(29, apr, 1951)) 
%Berikutnya orang(ui, yansen) diikatkan ke variabel Orang, dan tanggal_lahir diikatkan ke variabel Tanggal
%Subgoal berikutnya yaitu cek_bulan_ulang_tahun(Bulan_ini, Tanggal)
%Selanjutnya dilakukan pencocokan apakah cek_bulan_ulang_tahun(December, tanggal_lahir(29, apr, 1951))
